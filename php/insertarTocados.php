<?php
	...
	$sql1 = "select fecha from aTocar where codK=" .$codK. " and emailBar='" .$emailBar. "'";
	$resultado1 = mysql_query($sql1) or die('Error. '.mysql_error());

	$fecha = mysql_fetch_array($resultado1);

	
	$sql2 = "delete from aTocar where codK=" .$codK. " and emailBar='" .$emailBar. "'";
	$resultado2 = mysql_query($sql2) or die('Error. '.mysql_error());

	
    $sql3 = "insert into tocados select emailBar, codk, nombreA, nombreC, '" .$fecha[0]. "' from karaokesBar where codk=" .$codK;
